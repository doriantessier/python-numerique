...
# %%
# votre code
moon = pd.read_csv('data/objects-on-the-moon.csv')
print(moon.shape)
moon.head()
...
# %%
# votre code
moon.dropna(axis=1, how='all', inplace=True)
moon.head()
...
moon.dropna(axis=0, how='all', inplace=True)
moon.head()
...
# votre code
moon.dtypes
#les masses sont comptées comme objects et non comme des entiers ou  des flottants
...
# votre code
moon['Mass (lb)'].unique()
#il y a un nan ainsi que 4 autres valeurs faussées
...
# %%
# votre code
moon['Mass (lb) orig'] = moon['Mass (lb)']
moon['Mass (lb)'] = pd.to_numeric(moon['Mass (lb)'], errors = 'coerce')
moon['Mass (lb)'].dtype
